...
export default function PersistentDrawerLeft() {
	...
	React.useEffect(() => {
		axios
			.get(
				`https://virtualclassloc.herokuapp.com/student/search_batches?userId=${localStorage.getItem(
					"userId"
				)}`
			)
			.then((response) => {
...
*/
	React.useEffect(() => {
		axios
			.get(
				`https://virtualclassloc.herokuapp.com/student/enrolled_batches/?studentId=${localStorage.getItem(
					"userId"
				)}`
			)
			.then((response) => {
	...
	const handleSendId = (event) => {
		...
		axios
			.get(
				`https://virtualclassloc.herokuapp.com/student/enroll_batch/?studentId=${localStorage.getItem(
					"userId"
				)}&batchId=${uid}`
			)
			.then((response) => {
